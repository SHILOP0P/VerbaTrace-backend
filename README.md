...
- **Письма аккаунту**: ссылка сброса пароля и письмо зарегистрированному пользователю о новом приглашении («Вас пригласили в компанию …») идут в очередь с адресом аккаунта. Содержимое письма с секретом (`sensitive`) стирается после отправки. Пока отправитель `mock`, письма никуда не уходят; приглашение по адресу человека без аккаунта в эту версию не входит.
