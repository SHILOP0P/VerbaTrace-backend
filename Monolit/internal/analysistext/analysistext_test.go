...
func TestStripReferenceIDs(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "source_segments", text: "В source_segments нет ответа.", want: "В репликах нет ответа."},
		{name: "field after в", text: "Это покрывает текст требования в assigned_unit.", want: "Это покрывает текст требования в пункте."},
		{name: "field after из", text: "Слова из assigned_unit прозвучали.", want: "Слова из пункта прозвучали."},
		{name: "field after по", text: "Проверено по source_segments.", want: "Проверено по репликам."},
		{name: "field after a dative noun", text: "Это соответствует частям assigned_unit.", want: "Это соответствует частям пункта."},
		{name: "transliterated field", text: "Вопрос юнита относится к брони, как и юниты выше.", want: "Вопрос пункта относится к брони, как и пункты выше."},
		{name: "transliteration inside a word stays", text: "Коммунитарный подход.", want: "Коммунитарный подход."},
